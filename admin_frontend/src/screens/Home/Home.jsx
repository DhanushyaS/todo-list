...
function Home() {
  return (
    <div className="vh-100 home">
      {/* <TodoList /> */}
      <h1 className="text-center fs-1 fw-bold py-5">ADMIN</h1>
      <div className="row" style={{padding:'0px 5px 0px 5px '}}>
      <div className="col">
        <Link to='/signup' className='text-dark link'>
          <div className="card shadow nav-card-add  text-center">
            <div className="card-body d-flex justify-content-center align-items-center">
              ...
              <div className="mt-3 fs-3">ADD NEW ADMIN</div>
              </div>
            </div>
          </div>
          </Link>
        ...
        <Link to='/product' className='text-dark link' >
          <div className="card shadow nav-card-todo  text-center">
            <div className="card-body d-flex justify-content-center align-items-center">
              ...
              <div className="mt-3 fs-3">VIEW PRODUCTS</div>
              </div>
            </div>
          </div>
          </Link>
        ...
        <Link to='/add' className='text-dark link'>
          <div className="card shadow nav-card-add  text-center">
            <div className="card-body d-flex justify-content-center align-items-center">
              ...
              <div className="mt-3 fs-3">ADD PRODUCT</div>
              </div>
            </div>
          </div>
          </Link>
